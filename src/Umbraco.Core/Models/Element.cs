...
//todo elements: Rename content => element
...
public class Element : ContentBase, IElement
{
    ...
    /// <summary>
    ///     Constructor for creating a Element object
    /// </summary>
    ...
    public Element(string name, IContentBase parent, IContentType contentType, string? culture = null)
    ...
    /// <param name="culture">An optional culture.</param>
    public Element(string name, IContentBase parent, IContentType contentType, int userId, string? culture = null)
        : this(name, parent, contentType, new PropertyCollection(), culture)
    {
        CreatorId = userId;
        WriterId = userId;
    ...
    /// <param name="culture">An optional culture.</param>
    public Element(string name, IContentBase parent, IContentType contentType, PropertyCollection properties, string? culture = null)
    ...
    /// <param name="contentType">ContentType for the current Content object</param>
    /// <param name="culture">An optional culture.</param>
    public Element(string? name, int parentId, IContentTypeComposition? contentType, string? culture = null)
    ...
    /// <param name="properties">Collection of properties</param>
    /// <param name="culture">An optional culture.</param>
    public Element(string? name, int parentId, IContentTypeComposition? contentType, PropertyCollection properties, string? culture = null)
    ...
    protected override void PerformDeepClone(object clone)
    {
        ...
        var clonedContent = (Element)clone;
