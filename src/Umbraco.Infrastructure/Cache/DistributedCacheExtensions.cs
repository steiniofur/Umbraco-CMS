...
public static class DistributedCacheExtensions
{
    ...
    public static void RefreshUserCache(this DistributedCache dc, IEnumerable<IUser> users)
        => dc.RefreshByPayload(UserCacheRefresher.UniqueId, users.Select(x => new UserCacheRefresher.JsonPayload(x.Id)));
    ...
    public static void RefreshTemplateCache(this DistributedCache dc, IEnumerable<ITemplate> templates)
        => dc.RefreshByPayload(TemplateCacheRefresher.UniqueId, templates.Select(x => new TemplateCacheRefresher.JsonPayload(x.Id, false)));
    ...
    public static void RemoveTemplateCache(this DistributedCache dc, IEnumerable<ITemplate> templates)
        => dc.RefreshByPayload(TemplateCacheRefresher.UniqueId, templates.Select(x => new TemplateCacheRefresher.JsonPayload(x.Id, true)));
