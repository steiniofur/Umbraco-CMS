...
test.describe('Stylesheet Folder tests', () => {
  ...
  test('can delete stylesheet folder', async ({page, umbracoApi, umbracoUi}) => {
    ...
    // Assert
    // Checks if the stylesheet was deleted
    await expect(await umbracoApi.stylesheet.doesStylesheetWithNameExistAtRoot(stylesheetFolderName)).toBeFalsy();
  });

  test('can add a stylesheet folder in another', async ({page, umbracoApi, umbracoUi}) => {
  ...
  test('can add a stylesheet folder in a folder in another folder', async ({page, umbracoApi, umbracoUi}) => {
    const childFolderName = 'childFolder';
  ...
  test('can delete a stylesheet folder in another folder', async ({page, umbracoApi, umbracoUi}) => {
    const childFolderName = 'childFolder';
