...
test.describe('Stylesheet tests', () => {
  ...
  test('can create stylesheet', async ({page, umbracoApi, umbracoUi}) => {
  ...
  test('can update stylesheet', async ({page, umbracoApi, umbracoUi}) => {
  ...
  test('can delete stylesheet', async ({page, umbracoApi, umbracoUi}) => {
    await umbracoApi.stylesheet.createStylesheet(stylesheetName, 'content');
