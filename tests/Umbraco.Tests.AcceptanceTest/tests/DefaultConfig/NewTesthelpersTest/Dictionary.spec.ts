...
test.describe('Dictionary tests', () => {
  ...
  test('can create dictionary', async ({page, umbracoApi, umbracoUi}) => {
  ...
  test('can update dictionary', async ({page, umbracoApi, umbracoUi}) => {
  ...
  test('can delete dictionary', async ({page, umbracoApi, umbracoUi}) => {
