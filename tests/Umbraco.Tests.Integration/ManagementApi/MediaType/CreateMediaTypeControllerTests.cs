...
{
    protected override Expression<Func<CreateMediaTypeController, object>> MethodSelector => x => x.Create(null);
    ...
    {
        CreateMediaTypeRequestModel createMediaTypeRequest = new() { Name = "Test", Alias = "test" };
